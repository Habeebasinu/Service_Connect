    ...
    <div className="min-h-screen  from-purple-50 via-white to-pink-50 px-4 sm:px-6 py-6 sm:py-10">
      ...
      <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="relative">
          ...
          <h1 className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 text-xl sm:text-2xl md:text-3xl font-extrabold text-white drop-shadow-lg">
            {service.service}
          </h1>
        </div>
        ...
        <div className="p-5 sm:p-8">
          ...
          <div className="mt-8 sm:mt-10 flex justify-center">
            <button
              onClick={() => click(id)}
              className="px-8 sm:px-10 py-3  from-purple-600 to-pink-600 text-white rounded-full font-semibold text-base sm:text-lg shadow-lg hover:scale-105 hover:shadow-xl transition"
            >
              Book Service
            </button>
          </div>
