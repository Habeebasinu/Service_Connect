...
function ProviderHome() {
  ...
  return (
    <div className="w-full min-h-screen px-6 md:px-10 py-8 bg-gray-50 text-gray-800">
      ...
      <div className="mb-10">
        ...
        <p className="text-gray-600 mt-2 text-sm">
          Overview of your services and bookings
        </p>
      </div>
      ...
      <div className="flex flex-wrap gap-4 mt-10">
        ...
        <button
          onClick={() => nav("/provider/booking")}
          className="bg-white border border-blue-600 text-blue-600 font-semibold px-6 py-2.5 rounded-lg hover:bg-blue-50 transition"
        >
          View All Bookings
        </button>
      </div>
